...
export function Footer() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -bottom-40 -right-40 w-80 h-80 bg-devoops-cyan rounded-full filter blur-3xl opacity-10 animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-16">
          ...
          >
            ...
            <p className="text-gray-400 text-lg">
              Where bugs become features and every 'oops' moment leads to innovation
            </p>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-xl font-bold text-white mb-6 border-b border-gray-800 pb-2">Navigation</h3>
            <ul className="space-y-3">
              <li>
                <a href="#work" className="text-gray-400 transition-colors flex items-center">
              ...
              <li>
                <a href="#about" className="text-gray-400 transition-colors flex items-center">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                  About
              ...
              <li>
                <a href="#services" className="text-gray-400 transition-colors flex items-center">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                  Services
              ...
              <li>
                <a href="#faq" className="text-gray-400 transition-colors flex items-center">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                  FAQ
              ...
              <li>
                <a href="/contact" className="text-gray-400 transition-colors flex items-center">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                  Contact
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-xl font-bold text-white mb-6 border-b border-gray-800 pb-2">Services</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-400 hover:text-devoops-white transition-colors flex items-center">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                  UI/UX Design
          ...
          >
            <h3 className="text-xl font-bold text-white mb-6 border-b border-gray-800 pb-2">Newsletter</h3>
            <p className="text-gray-400 mb-4">Subscribe to receive updates on our latest projects and tech insights.</p>
            ...
            <div className="rounded-lg p-5 border border-gray-800 bg-black/30 backdrop-blur-sm">
              ...
              <p className="text-gray-400 mb-1">123 Innovation Drive, Tech City, CA 94103</p>
              <p className="text-gray-400 mb-1">Email: hello@devoops.dev</p>
